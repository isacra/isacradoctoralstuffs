...
that are of primary interest in reservoir are generally poorly resolved \cite{Zhang2012}.
...
previewsly defined \cite{}. However, it has been proved that the mean solution is closer to a bandwidth limited solution,
...
is assuming a blocky model for the earth's impedance \cite{Cook2010}. However, this assumtion is not always valid,
and in some cases the high frequencies in the inverted impedance are ignored \cite{YuanWang2015}.
Very recent methods aims to enhance the seismic resolution and, by consequence, achieving an improvement in seismic inversion and reservoir characterization.
