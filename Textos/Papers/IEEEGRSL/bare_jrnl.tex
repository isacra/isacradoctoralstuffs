...
a fluvial channel system composed of three layers:


mwe perform the \textit{Maximum-a-Posteriori} (MAP) inversion using
the synthetic seismic, and estimated Ricker wavelet and the low frequency
model calculated by applying a low-pass filter with $4Hz$
cutting frequency. 
