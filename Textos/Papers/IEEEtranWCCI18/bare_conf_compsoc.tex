...
The randomly rotated wedges are related to lithologies positioned at a random angle.
In this case, we evaluate the CNN capability to deblur the wedges which shape and
position is absent of the training dataset.
We firstly test the wedges with the acoustic impedance normalized to values equals to $0$ and $1$.
Considering that Fig. \ref{fig_scenario4}  As the same range of values were used during
