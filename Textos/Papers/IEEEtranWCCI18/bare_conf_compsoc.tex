...
\begin{figure*}[!t]
\centering
\subfloat[Synthetic acoustic impedance images.]{\includegraphics[width=2.0in]{Figs/Caso4/synthetic.png}%
\label{fig_scenario4_synthetic}}
\hfil
\subfloat[Blurry images filtered with cutting frequency in $4Hz$]{\includegraphics[width=2.0in]{Figs/Caso4/blurred.png}%
\label{fig_scenario4_blurred}}
\hfil
\subfloat[Deblurred acoustic impedance images.]{\includegraphics[width=2.0in]{Figs/Caso4/cnn.png}%
