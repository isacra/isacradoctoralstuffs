...
exploratory targets in seismic scale. The seismic data are band-limited, in other words,
...
impedance models, that lacks of high-frequency details.
...
Each network layer maps higher level features originated in the lower layer through convolutional filters.
...
\subsection{Acoustic Impedance Images}
