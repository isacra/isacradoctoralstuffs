...
%A solução
We approach the problem of deblurring acoustic impedance images through
the Convolution Neural Networks (CNN). The availability of benchmarks
\cite{} and the advances in Graphical Processing Unit (GPU) \cite{Buduma15}
allowed CNN to outperform thechniques in detection \cite{}, model-free
tracking \cite{}, classification \cite{}.
