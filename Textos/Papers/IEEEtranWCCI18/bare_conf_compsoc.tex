...
that these methods work properly on synthetic blurs. However, they failure
when applied to real world blury images \cite{} and keep a high computational cost \cite{}.
...
non-linear function or blur kernels. Thus, de-blurring becomes a function of a blur image
...
CNN can remedy this problem by estimating its kernels, which are convolved along the
training images. T
