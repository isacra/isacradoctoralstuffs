...
on which the wavelet reflects. This charachteristic is called reflectivity coeficient and it is
calculated as
\begin{equation}
...
\end{equation}
where, $N$ is the number of subsurface layers, $e_d(t)$ is a random noise in function of the time.
...
Several works have developed different deblurring methods for different purposes.
referencciar os trabalhos.
