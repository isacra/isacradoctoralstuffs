...
way that the quantitative predictions about the reservoir behaviour is
possible \cite{}. These data are usually, but not exclusively, geological models,
data logs, testimunhal data, production summary and 3D seismic data. The seismic
amplitude is used in model generation and  reservoir characterization,
however, the deeper the investigated horizon is, the bigger the limit in using the seismic amplitude data \cite{}. 
In this context, inverting the seismic data to acoustic impedance plays an important role,
once it accurately integrates the seismic information
to generate models that contribute to the subsurface characterization.
According to \cite{}, a good acoustic impedance model contains more information
...
The Inversion techniques, such as Maximum-a-posteriori(MAP), Recursive
Inversion and Sparse Spike, produce blurred images. Deblurring is an important
task in post-inversion decision making.
...
\bibitem{Liu} Liu Lihui, Lu Rong, Li Jianhai, Yang Wenkui, ``Seismic Lithofacies Computation Method Based on Deep Learning,'' 649-652. 10.1190/IGC2017-165.
...
\bibitem{Latimer} Rebecca Buxton Latimer, Rick Davidson, Paul van Riel, ``An interpreter's guide to understanding and working with seismic-derived acoustic impedance data,'',2017, pp. 242-256, vol. 19, num. 3, in The Leading Edge.
\end{thebibliography}
