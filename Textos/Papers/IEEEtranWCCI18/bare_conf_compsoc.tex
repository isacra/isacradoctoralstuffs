...
\hfil
\subfloat[Blurry images filtered with cutting frequency in $4Hz$]{\includegraphics[width=2.0in]{Figs/Caso1/blurred.png}%
...
column shows that the model precisely recovered the range of frequencies
...
\hfil
\subfloat[Blurry images filtered with cutting frequency in $4Hz$]{\includegraphics[width=2.0in]{Figs/Caso6/blurred.png}%
...
\hfil
\subfloat[Blurry images filtered with cutting frequency in $4Hz$]{\includegraphics[width=2.0in]{Figs/Caso2/blurred.png}%
...
\hfil
\subfloat[Blurry images filtered with cutting frequency in $4Hz$]{\includegraphics[width=2.0in]{Figs/Caso5/blurred.png}%
...
\begin{figure*}[!t]
\centering
\subfloat[Synthetic acoustic impedance images.]{\includegraphics[width=2.2in]{Figs/Caso1/frequencies}%
\label{fig_frequencies_2}}
\hfil
\subfloat[Blurry images filtered with cutting frequency in $4Hz$]{\includegraphics[width=2.2in]{Figs/Caso2/frequencies}%
\label{fig_frequencies_3}}
\hfil
\subfloat[Deblurred acoustic impedance images.]{\includegraphics[width=2.2in]{Figs/Caso4/frequencies}%
...
\begin{figure*}[!t]
\centering
\subfloat[Blurry images filtered with cutting frequency in $4Hz$]{\includegraphics[width=2.2in]{Figs/Caso5/frequencies}%
\label{fig_frequencies_5}}
\hfil
\subfloat[Blurry images filtered with cutting frequency in $4Hz$]{\includegraphics[width=2.2in]{Figs/Caso6/frequencies}%
