...
in angles countable multiples of $90$ degrees. This approach allows the model learning the maximum edge variabilities in wedges images.
\begin{figure}[!t]
\centering
...
delivered in MATLAB R2017A. The network weights are
randomly initialized and the Stochastic Gradient Descendant with
Momentum (SGDM) \cite{Ning} is used to minimize the MSE for mini-batches with
$32$ training examples.

\subsection{Rotated Wedges}
