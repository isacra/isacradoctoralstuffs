...
is a common practice in reservoir characterization \cite{}. It allows studying
the results of the algorithms without external interferences and leads to efficient
...
\section{Experiments}
The model was first trained with a synthetic dataset.
