...
Similarly to the first test case, the model achieved lower RMSE for the deblurred images and higher similarity.
Except for the Example 3and recover all the frequency spectrum (Fig. \ref{fig_scenario6}), the similarity
