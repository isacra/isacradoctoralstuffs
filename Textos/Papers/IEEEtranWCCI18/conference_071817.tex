...
The architecture of our is divided into two basic structures: convolutional layers and regression unit. The convolutional layers highlight edges and contours related to
...
predicted the pixel intensities. Tab. \ref{table_caso_1} shows that the error values related to the network output and the latent images are considerably lower than the RMSE related to the latent and the blurry images. Furthermore, the FFTI slightly increased and indicates more similarity among the outputs
...
show that the RMSE slightly decreased, while the similarity with the latent image increased.
\begin{figure*}[!t]
\centering
\subfloat[Synthetic acoustic impedance images.]{\includegraphics[width=1.5in]{Figs/Caso2/synthetic.png}%
\label{fig_scenario2_synthetic}}
\subfloat[Equivalent blurry images.]{\includegraphics[width=1.5in]{Figs/Caso2/blurred.png}%
\label{fig_scenario2_blurred}}
\subfloat[Deblurred acoustic impedance images.]{\includegraphics[width=1.5in]{Figs/Caso2/cnn.png}%
...
cutting frequency, randomly choosing between $3$ and $20 Hz$. 
Fig. \ref{fig_scenario5} shows that the model deblurred images containing different blurry resolution, and
highlighted edges as well as possible interfaces between rock layers. Metrics in Tab. \ref{table_caso_5} show that the RMSE of each CNN output is lower than the RMSE of the blurry images, even though its magnitude is considered non-representative.
\begin{figure*}[!t]
\centering
\subfloat[Synthetic acoustic impedance images.]{\includegraphics[width=1.5in]{Figs/Caso5/synthetic.png}%
\label{fig_scenario5_synthetic}}
\subfloat[Equivalent blurry images.]{\includegraphics[width=1.5in]{Figs/Caso5/blurred.png}%
\label{fig_scenario5_blurred}}
\subfloat[Deblurred acoustic impedance images.]{\includegraphics[width=1.5in]{Figs/Caso5/cnn.png}%
...
Hier, we tested the network capability to deblur wedges with random shapes, at random position in the image.
Additionally, this test case is comprised of images with acoustic impedance normalized to values equal to $0$ and $1$.
...
(Tab. \ref{table_caso_6}). In examples $2$ and $4$, the model's outputs presented RMSE values lower than the blurry images, 
...
\begin{figure}[!h]
	...
	\rotatebox{90}{
		...
		\subfloat[Third test case.]{\includegraphics[width=2.5in]{Figs/Caso5/frequencies}%
