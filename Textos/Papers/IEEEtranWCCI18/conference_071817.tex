...
% Similar to the previews case, the model recovers the frequency magnitudes,
% illustrated in Fig. \ref{fig_frequencies_3}, however with magnitude slightly lower in the region of higher
% frequencies.
