...
clearly observeble the interfaces between different rock layers,
...
Using the seismmic data in deepwater reservoir modeling leads to errors in estimating
the reservoir properties, beacause such data do not allow the wide understanding of the field
...
%we invert the impedance values in such a way that the wedges are set with normalized value equal to $1$, and $0$ out of it.
