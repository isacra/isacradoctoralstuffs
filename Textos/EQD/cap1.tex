...
No exemplo citado, tanto o problema direto quanto o inverso possui solução. Entretanto,
...
(problema não-determinístico), de modo que o mesmo conjunto de medidas
...
de queda da pedra $T$. Segundo, a natureza mal-posta do problema inverso, isto é,
uma pequena mudança arbitrária nos valores observados pode causar uma mudança grande
da solução fonte equivalente. Em um paralelo com o exemplo do poço, seria como
...
\begin{enumerate}
 ...
 \item Modelagem dos tipos de contato (interfaces / \textit{facies}) entre rochas\label{itm:2}.
 \item Modelagem da propriedade porosidade com base nos tipos de facies, antes da permeabilidade.
...
do seu relacionamento com conceitos mais simples \cite{Goodfellow2016}.
Assim, o aprendizado por experiência evita a necessidade de interferência
humana para especificar formalmente o conhecimento que o computado necessita,
...
O processo de super-resolução é uma forma de processamento de imagens e visão computacional.
...
considerada como imagem que representa a verdade. De um ponto de vista conceitual, o mapeamento $F$ consiste essencialmente em
...
\begin{enumerate}
 ...
 pode ser imaginado como um conjunto de sub-imagens com determinadas características da imagem.
...
Este trabalho busca atacar a problemática da super-resolução dos artefatos da inversão sísmica,
