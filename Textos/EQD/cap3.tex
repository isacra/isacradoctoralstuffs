...
\textit{A revisão da literatura foi realizada com as seguintes palavras-chaves:...\textbf{Falta fazer}
\textit{A revisão foi realizada sistematicamente nos seguintes periódicos:}...\textbf{Falta fazer}

Não há evidência, na literatura, de trabalhos que abordem o problema de aumento de resolução
de imagens de propriedades petrofísicas pós-inversão através de métodos de aprendizado supervisionado,
...
entre outros. Além disso, como já mencionado na seção \ref{sec:map}, o próprio processo de inversão
acústica, modula a sísmica durante a convolução. Assim, a estratégia sugerida neste trabalho
...
é uma abordagem recente. O modelo que representa o estado da arte em inversão acústica e redes convolucionais
para super-resolução são apresentados nas seções a seguir.
