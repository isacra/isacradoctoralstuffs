...
A parametrização do sistema se refere à definição do conjunto mínimo de elementos (parâmetros, variáveis)
...
A arquitetura típica de uma CNN compreende duas camadas convolucionais, cada uma é seguida por
