...
treinamento \abreviatura{IT}{Imagem de Treinamento} como dado de entrada para definir a estrutura espacial de um processo \cite{Guaridano1993,Strebelle2002}. 
...
\section{Simulação Multiponto Baseada em Blocos}
...
As redes neurais convolucionais \abreviatura{RNC}{Redes Neurais Convolucionais}, também conhecidas como \emph{Deep Learning}, estão atualmente no centro
das relacionadas a aprendizagem de máquina. As principais pesquisas relacionadas com as RNC são relacionadas à segmentação de imagem \cite{}, representação
espaço-temporal e reconhecimento de ações em vídeos \cite{};
